...
const SearchPage = () => {
    ...
    const [searchValue, setSearchValue] = useState<string>(''); // searchValue의 타입을 string으로 정의합니다.

    // debounce 함수 생성 - 함수가 매번 새로 생성되지 않도록 useCallback으로 감쌉니다.
    const debouncedSearch = useCallback(
        debounce((query: string) => { // query의 타입을 string으로 정의합니다.
            if (query) {
    ...
    // searchValue의 상태 변경 함수에 타입을 지정합니다.
