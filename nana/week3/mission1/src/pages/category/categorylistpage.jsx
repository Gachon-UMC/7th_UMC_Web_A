        ...
        <>
            <PageContainer>
                ...
                <SelectCategorydiv>
                    ...
                    {/* 현재 상영중인 클릭시 /category/now-playing 페이지로 이동 */}
                    <Link to={'/category/now-playing'}>
                        {/* NowPlaying category div */}
                        <NowPlaying>
                            {/* 카테고리 이름 컨테이너 정의 */}
                    ...
                    {/* 인기있는 클릭시 /category/popular 페이지로 이동 */}
                    ...
                    {/* 높이 평가를 받은 클릭시 /category/top-rated 페이지로 이동 */}
                    <Link to={'/category/top-rated'}>
                        {/* top-rated category div */}
                        <TopRated>
                            <TextOverlay>높은 평가를 받은</TextOverlay>
                        </TopRated>
                    </Link>
                    
                    {/* 개봉 예정중인 클릭시 /category/up-coming 페이지로 이동 */}
                    <Link to={'/category/up-coming'}>
                        {/* up-coming category div */}
                        <Upcoming>
