...
const MoviesPage = () => {
  ...
  useEffect(() => {
    const getMovies = async () => {
      ...
      const movies = await axios.get(`https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=ko-KR&page=1&sort_by=popularity.desc`, {
            headers: {
